...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-08-2020 a las 21:49:22
...
--
-- Base de datos: `db_roaming_honduras`
--
CREATE DATABASE IF NOT EXISTS `db_roaming_honduras` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci;
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `codigo_cliente` varchar(15) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `dui` varchar(9) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `nit` varchar(14) COLLATE utf8mb4_spanish2_ci NOT NULL,
  ...
  `numero_telefono` varchar(8) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `estado` char(1) COLLATE utf8mb4_spanish2_ci NOT NULL,
  PRIMARY KEY (`idcliente`),
  KEY `fk_cliente_reference_tipocliente` (`idtipocliente`)
...
INSERT DELAYED IGNORE INTO `cliente` (`idcliente`, `idtipocliente`, `codigo_cliente`, `dui`, `nit`, `apellidos`, `nombres`, `sexo`, `numero_telefono`, `estado`) VALUES
...
CREATE TABLE IF NOT EXISTS `facturacion` (
  ...
  KEY `fk_facturacion_reference_clientes` (`idcliente`)
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
INSERT DELAYED IGNORE INTO `facturacion` (`idfacturacion`, `idcliente`, `monto_facturacion`) VALUES
(1, 1421, '56.00'),
(2, 2164, '90.60'),
(3, 30105, '80.10'),
(4, 5909, '121.80'),
...
--
-- Truncar tablas antes de insertar `tipo_clientes`
--

TRUNCATE TABLE `tipo_clientes`;
--
-- Volcado de datos para la tabla `tipo_clientes`
--

INSERT DELAYED IGNORE INTO `tipo_clientes` (`idtipocliente`, `nombre_tipo`) VALUES
